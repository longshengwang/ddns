...
//        BasicConfigurator.configure();
    ...
    public static Map<SelectionKey, Socket> keySocketMap =  new HashMap<SelectionKey, Socket>();
    /**
     * 日志
     */
...
//                        LOGGER.info("======socket channel 建立连接=======");
                        Socket innerSocket = new Socket("localhost", 22);
                        SocketChannel channel = innerSocket.getChannel();
                        if(keySocketMap.get(readyKey) == null){
                            keySocketMap.put( readyKey, innerSocket);
                        }
...
//            LOGGER.warn("====缓存区没有数据？====");
        ...
        Socket socket = keySocketMap.get(readyKey);
